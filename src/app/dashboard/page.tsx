...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState<
    "clients" | "fulfilment" | "fulfilled" | "email"
  >("clients");
  ...
  const getFilteredUsers = () => {
    return users.filter((user) => {
      ...
      if (activeTab === "clients" || activeTab === "email") {
        return basicFilters;
            ...
            <div className="bg-blue-50 p-3 rounded-lg mb-6 border border-blue-200 flex justify-between items-center">
              <div className="flex items-center">
                ...
                <span className="text-blue-700">
                  {selectedUsers.length} of {filteredUsers.length} clients
                  selected
                </span>
              </div>
              <div className="flex space-x-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {activeTab === "clients" && (
                        <button
                          ...
                          className="text-gray-600 hover:text-gray-700 text-sm font-medium flex items-center cursor-pointer"
                        >
                    ...
                    <tr key={user.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end space-x-2">
                          <button
                            onClick={() =>
                              handleViewClientDetails(user.id || "")
                            }
