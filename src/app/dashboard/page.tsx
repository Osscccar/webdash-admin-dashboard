    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <input
          ...
          className="w-full md:w-1/2 px-4 py-2 bg-gray-700 text-white rounded-md border border-gray-600 placeholder-gray-400"
        />

        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value)}
          className="w-full md:w-1/4 px-4 py-2 bg-gray-700 text-white rounded-md border border-gray-600"
        >
